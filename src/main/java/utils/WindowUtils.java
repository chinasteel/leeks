...
public class WindowUtils {
    ...
    public static final String STOCK_TABLE_HEADER_VALUE = "股票名称,涨跌幅,最高价,最低价,当前价,涨跌,编码,成本价,持仓,收益率,收益,更新时间";
    public static final String STOCK_TABLE_HEADER_WIDTH_KEY = "stock_table_header_width_key2";
    //货币表头
